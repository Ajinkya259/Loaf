...
**Why the camera never moves.** A fixed camera
...
**Why landscape, not portrait.** A humanoid character is taller than wide in every
pose. A quadruped cat in profile is the opposite: 2.03 wide against 1.56
...
**Profile is for locomotion. Front is for personality.**
